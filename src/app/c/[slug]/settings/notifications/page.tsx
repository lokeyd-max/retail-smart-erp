  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Link href={`${basePath}/settings/notifications/sms`}>
        ...
        <Link href={`${basePath}/settings/notifications/email`}>
          <Card className="p-4 hover:border-blue-500 transition-colors cursor-pointer">
            <div className="flex items-center gap-3">
        ...
        <Link href={`${basePath}/settings/notifications/templates`}>
          <Card className="p-4 hover:border-blue-500 transition-colors cursor-pointer">
            <div className="flex items-center gap-3">
        ...
        <Link href={`${basePath}/settings/notifications/logs`}>
          <Card className="p-4 hover:border-blue-500 transition-colors cursor-pointer">
            <div className="flex items-center gap-3">
      ...
      <Card className="p-4">
        ...
        <div className="flex gap-3">
          ...
          <Link href={`${basePath}/settings/notifications/sms-center`}>
      ...
      <Card className="p-4 bg-blue-50 border-blue-200">
        ...
        <ul className="mt-2 text-sm text-blue-800 space-y-1 list-disc list-inside">
          ...
          <li>Email notifications are sent automatically from your company address</li>
