      ...
      <Card className="p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-gray-50 rounded">
            <div className="flex items-center gap-2 mb-2">
              <Mail className="w-4 h-4 text-blue-600" />
              <h4 className="font-medium text-sm text-gray-900">Reply-To</h4>
            </div>
            <p className="text-xs text-gray-600">
              Customer replies go to your company email address registered in your profile.
            </p>
          </div>
          ...
          <div className="p-4 bg-gray-50 rounded">
            <div className="flex items-center gap-2 mb-2">
              <Mail className="w-4 h-4 text-blue-600" />
              <h4 className="font-medium text-sm text-gray-900">Auto-Triggers</h4>
            </div>
            <p className="text-xs text-gray-600">
              Set up notification templates to automatically email customers on events like appointments or work orders.
            </p>
          </div>
        </div>
      </Card>
