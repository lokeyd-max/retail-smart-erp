...
import { Plus, Pencil, Trash2, FolderPlus, ChevronDown, ChevronRight, Download, Upload } from 'lucide-react'
  ...
  return (
      ...
      actionContent={
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 border border-blue-600 text-blue-600 text-sm font-medium rounded hover:bg-blue-50 transition-colors"
          >
            <FolderPlus size={16} />
            Add Group
          </button>
    ...
    >
      ...
      <ImportWizard
        ...
        onClose={closeImport}
        defaultEntity="service-types"
        onComplete={() => fetchServiceTypes()}
      />
    </ListPageLayout>
  )
}
